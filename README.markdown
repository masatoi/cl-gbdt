...
LightGBM and XGBoost shared libraries, exercised by 564 functional assertions across 12 test
files (design doc section 12, layer 2), in addition to 433 assertions across 18 test files
