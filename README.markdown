...
LightGBM and XGBoost shared libraries, exercised by 353 functional assertions (design doc
section 12, layer 2), in addition to 353 assertions that need no shared library at all
