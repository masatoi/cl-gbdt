...
the rest -- against the real shared libraries, exercised by 470 functional assertions in
`cl-gbdt/tests/functional` (layer 2) on top of 399 assertions that need no shared
