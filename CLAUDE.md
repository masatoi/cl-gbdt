...
the rest -- against the real shared libraries, exercised by 353 functional assertions in
`cl-gbdt/tests/functional` (layer 2) on top of 353 assertions that need no shared
