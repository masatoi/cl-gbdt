...
the rest -- against the real shared libraries, exercised by 401 functional assertions in
`cl-gbdt/tests/functional` (layer 2) on top of 374 assertions that need no shared
