...
the rest -- against the real shared libraries, exercised by 302 functional assertions in
`cl-gbdt/tests/functional` (layer 2) on top of 328 assertions that need no shared
