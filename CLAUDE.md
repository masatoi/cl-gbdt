...
the rest -- against the real shared libraries, exercised by 298 functional assertions in
`cl-gbdt/tests/functional` (layer 2) on top of 320 assertions that need no shared
