(:mallet-config
 ...
 ;; `with-dataset', `with-booster' and `with-backend' still release their resource when
 ;; the body signals. That is the opposite of swallowing an error -- the signal is the
