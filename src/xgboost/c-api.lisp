...
(uiop:define-package #:cl-gbdt/src/xgboost/c-api
  (:use #:cl)
  (:import-from #:cffi)
  (:documentation "Raw CFFI bindings for the C API declared in xgboost/c_api.h.
...
(in-package #:cl-gbdt/src/xgboost/c-api)
