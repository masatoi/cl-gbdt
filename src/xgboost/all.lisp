...
;;;
;;; So this re-exports `cl-gbdt/src/xgboost/protocol' only, which today exports exactly one
;;; symbol, `xgboost-backend' -- the CLOS class a caller can specialize methods on or check
;;; with `typep'. Nothing from `native' is published here: none of its current exports is a
;;; reviewed, Lisp-level XGBoost-specific operation -- that is Phase 2's job
